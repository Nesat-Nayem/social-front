          ...
          <div class="row merged20" id="page-contents">
            ...
            <div class="col-lg-9">
              ...
              <div class="central-meta padding30">
                <div class="row merged20">
                  <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="friend-block">
                      <figure>
                        <img src="images/blood-transfusion.png" alt="" style="
                                  width: 60px;
                                  height: 60px;
                                  object-fit: contain;
                                " />
                      ...
                      <div class="frnd-meta">
                        <div class="frnd-name">
                          <a href="#" title="">Dr. Smith</a>
                          <span>India MH, Pune</span>
                        </div>
                        <a class="send-mesg mx-2" href="#" title="">Message</a>
                        |
                        <a class="px-2 text-success" href="tel:5551234567" title="">
                ...
                <div class="lodmore">
                  <span>Viewing 1-16 of 30 Blood Banks</span>
