    ...
    <div class="theme-layout">
      ...
      <div class="responsive-header">
        <div class="mh-head first Sticky">
          ...
          <span class="mh-text">
            <a href="/" title=""><img src="images/logo.png" alt="logo" style="width: 40px; height: 40px" /></a>
          </span>
          <span class="mh-btns-right" style="display: flex">
            <ul class="setting-area float-left" style="list-style: none">
              <li>
                <a href="notifications.html" title="Notification" data-ripple="">
                  <i><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none"
                      stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                      class="feather feather-bell">
                      <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
                      <path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
                    </svg></i><em class="bg-purple" style="
                      position: absolute;
                      top: -11px;
                      right: 5px;
                      width: 16px;
        ...
        <nav id="menu" class="res-menu">
          <ul>
            ...
            <li>
              <span>Add Post</span>
              <ul>
                <li><a href="about-us.html" title="">Social Post</a></li>
                <li>
                  <a href="/" title="">Road Accident</a>
                </li>
                <li>
                  <a href="blood-donation.html" title="">Blood Donation</a>
                </li>

                <li><a href="organ-donation.html" title="">Organ Donation</a></li>
                <li>
                  <a href="medical-fundraising.html" title="">Medical Fundraising</a>
                </li>
              </ul>
            </li>
            <li>
              <span>Services</span>
              <ul>
                <li><a href="social-issues.html" title="">Social Issues</a></li>
                <li>
                  <a href="medical-issues.html" title="">Medical Issues</a>
                </li>
                <li>
                ...
                <li>
                  <a href="voters-summary.html" title="">Voters Summary</a>
                </li>
                <li><a href="opinion-poll.html" title="">Opinion Poll</a></li>
              </ul>
            </li>
            <li>
              <span>Timeline</span>
            ...
            <li>
              ...
              <ul>
                <li>
                  <a href="chat-messenger.html" title="">Messenger </a>
                </li>
      ...
      <div class="topbar stick">
        <div class="logo">
          <a title="" href="/"><img src="images/logo.png" alt="logo" style="width: 40px; height: 40px" /></a>
        </div>
        <div class="top-area">
          <div class="main-menu">
            <span>
          ...
          <div class="top-search">
            <form method="post" class="">
              ...
              <button data-ripple>
                <i><svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 512 512" class="search-icon"
          ...
          <ul class="setting-area float-left">
            <li>
              <a href="/"><i>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 514 458.5" class="" height="15px" fill="white">
                    <path
            ...
            <li>
              ...
              <div class="dropdowns">
                ...
                <a href="friend-requests.html" title="" class="more-mesg" style="padding: 16px">View All</a>
              </div>
            </li>
            <li>
              ...
              <div class="dropdowns">
                <span style="padding: 16px">4 New Notifications
                  ...
                  <li>
                    <a href="notifications.html" title="">
                      ...
                      <div class="mesg-meta">
                        ...
                        <i>4 hours ago</i>
                        <figure>
                          <span>Today is Marina Valentineâ€™s Birthday! wish for
                            celebrating</span>
                ...
                <a href="notifications.html" title="" class="more-mesg" style="padding: 16px">View All</a>
              </div>
            </li>
            <li>
              <a href="#" title="Messages" data-ripple=""><i><svg xmlns="http://www.w3.org/2000/svg" width="17"
              ...
              <div class="dropdowns">
                <span style="padding: 16px">5 New Messages
                  <a href="#" title="">Mark all as read</a></span>
                <ul class="drops-menu">
                  <li>
                  ...
                  <li>
                    <a class="show-mesg" href="#" title="">
                      ...
                      <div class="mesg-meta">
                        <h6>Jhon doe</h6>
                        <span><i class="ti-check"></i> Weâ€™ll have to check that
                  ...
                  <li>
                    <a class="show-mesg" href="#" title="">
                      ...
                      <div class="mesg-meta">
                        <h6>Tom cruse</h6>
                        <span><i class="ti-check"></i> Great, Iâ€™ll see you
                          tomorrow!.</span>
                        <i>2 min ago</i>
                      </div>
                    </a>
                ...
                <a href="chat-messenger.html" title="" class="more-mesg" style="padding: 16px">View All</a>
              </div>
            </li>
          </ul>
          <div class="user-img">
            ...
            <div class="user-setting">
              <div class="d-flex" style="
                ...
                ">
                <img src="images/resources/admin.jpg" alt="user"
                  style="width: 40px; height: 40px; border-radius: 50%" />
                <div>
                  <p style="margin-bottom: -5px; color: #000">Suraj Jamdade</p>
                  <p class="" style="font-size: 12px">suraj@gmail.com</p>
                </div>
              </div>
              <ul class="log-out">
                <li>
                ...
                <li>
                  <a href="post-activity.html" title=""><i class="ti-target"></i>Post & activity</a>
                </li>
                <li>
                  <a href="support-and-help.html" title=""><i class="ti-settings"></i>Help</a>
                </li>
                <li>
        ...
        <nav>
          <ul class="nav-list">
            <li>
              <a class="" href="/" title=""><i class="fa fa-home"></i> Home
              </a>
            </li>
            <li>
              <a class="" href="about-us.html" title=""><i class="fa-solid fa-info"></i> About Us
              </a>
            </li>

            <li>
              <a class="" href="#" title=""><i class="fa-brands fa-servicestack"></i> Services
              </a>
              <ul>
                <li><a href="social-issues.html" title="">Social Issues</a></li>
                <li>
            ...
            <li>
              <a class="" href="#" title=""><i class="fa fa-heart"></i> Favorite Page</a>
              <ul>
                <li>
                  <a href="event-calendar.html" title="">Event Calendar</a>
                </li>
            ...
            <li>
              <a class="" href="#" title=""><i class="fa-solid fa-star"></i> Featured</a>
              <ul>
                <li>
                  <a href="chat-messenger.html" title="">Messenger</a>
                </li>
                ...
                <div class="row merged20" id="page-contents">
                  <div class="col-lg-12">
                    <div class="gap2 no-top">
                      <div class="central-meta no-margin d-none d-sm-block">
                        <ul class="nave-area">
                          <li class="active" style="color: #071c5d; font-weight: 900">
                            <a href="/" title=""><i class="fa-regular fa-home"></i>
                              Home</a>
                          </li>
                          <li>
                            <a href="daily-news" title=""><i class="fas fa-newspaper"></i>
                              News</a>
                          </li>
                          <li>
                            <a href="public-poll" title=""><i class="fas fa-poll-h"></i>
                              Public Poll</a>
                          </li>
                          <li>
                            <a href="voters-summary.html" title=""><i class="fas fa-child"></i>
                              voters summary</a>
                          </li>
                          <li>
                            <a href="opinion-poll.html" title=""><i class="fas fa-poll"></i>
                              opinion poll</a>
                          </li>
                      ...
                      <div class="widget">
                        ...
                        <ul class="naves">
                          ...
                          <li>
                            ...
                            <a href="/" title="">Social Issues</a>
                          </li>
                          <li>
                            <i class="fas fa-hospital" style="color: #000;"></i>
                            <a href="blood-donation.html" title="">Medical Issues</a>
                          </li>
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="central-meta postbox">
                      <form method="post" enctype="multipart/form-data" id="postForm">
                        ...
                        <span class="create-post">
                          <i class="fa-regular fa-stars"></i> Create post</span>
                        ...
                        <div class="new-postbox">
                          ...
                          <div class="newpst-input">
                            <form method="post">
                              <textarea rows="2" placeholder="Share some what you are thinking?" id="postText"
                          ...
                          <div class="attachments">
                            <ul>
                                      ...
                                      <div class="modal-body" style="height: 400px; overflow-y: scroll">
                                        <div class="send-message">
                                          <form method="post" class="c-form">
                                            <label style="font-size: 12px" for="message" class="mb-3">Your question
                                              *</label>
                                            <textarea class="form-control mb-4"
                                              placeholder="E.g.How do you commute to work ?" rows="2"
                                              required></textarea>
                                            ...
                                            <input style="height: 45px" type="text" placeholder="E.g.Drive myself"
                                              class="form-control mb-4" />
                                            <label style="font-size: 12px" for="message" class="mb-3">Poll duration
                                              *</label>
                              ...
                              <li>
                                <i class="fa-regular fa-calendar" title="create Event" data-toggle="modal"
                                  data-target="#eventAddModal" style="cursor: pointer"></i>
                                      ...
                                      <div class="modal-body" style="height: 400px; overflow-y: scroll">
                                        <div class="send-message">
                                          <form method="post" class="c-form">
                                            ...
                                            <input style="height: 45px" type="date" placeholder=""
                                              class="form-control mb-4" />
                                            <label style="font-size: 12px" for="" class="mb-3">Start Time *</label>
                                            <input style="height: 45px" type="time" placeholder=""
                                              class="form-control mb-4" />
                    ...
                    <div class="central-meta">
                      <span class="create-post">Short News
                        <a href="#" title="" style="color: #7635dc">See All</a></span>
                              ...
                              <div class="col-lg-4">
                                <div class="stories-users">
                                  ...
                                  <div class="my-status">
                                    ...
                                    <a href="#" title="" class="main-btn" id="fileContainer">Add New</a>
                      ...
                      <div class="user-post">
                        <div class="friend-info">
                          ...
                          <div class="friend-name">
                            ...
                            <span><i class="ti-bookmark-alt"></i> Follow similar
                              People</span>
                          </div>
                          ...
                          <div class="friend-info">
                            ...
                            <div class="post-meta">
                              <p>
                                ...
                                libero.
                                <a href="social-post-detail.html" title="" style="color: #7635dc">Read More</a>
                              </p>
                              <figure>
                                <div class="img-bunch">
                                  <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                      <figure>
                                        <a href="#" title="" data-toggle="modal" data-target="#img-comt">
                                          <img src="images/posts/1.webp" alt="post"
                          ...
                          <div class="friend-info">
                              ...
                              <div class="" style="
                                ...
                                <div class="your-page">
                                  <div class="page-likes">
                                    <ul class="nav nav-tabs likes-btn mb-5">
                                      <li class="nav-item">
                                        <a data-toggle="tab" href="#link1" class="active" style="padding: 30px">Yes</a>
                                      </li>
                                      <li class="nav-item">
                                        <a data-toggle="tab" href="#link2" class="" style="padding: 30px">No</a>
                                      </li>
                                    </ul>
                                    <!-- Tab panes -->
                                    <div class="tab-content">
                                      <div id="link1" class="tab-pane fade active show">
                            ...
                            <div class="coment-area">
                              <ul class="we-comet">
                                ...
                                <li>
                                  <a href="#" title="" class="showmore underline" style="color: #7635dc">more
                                    comments+</a>
                                </li>
                                <li class="post-comment">
                                  <div class="comet-avatar">
                            ...
                            <div class="post-meta">
                              <figure>
                                <a href="https://www.youtube.com/watch?v=fF382gwEnG8" title=""
                                  ...
                                  <img src="images/resources/user-post.jpg" alt="img"
                                  ...
                                  <i>
                                    <svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg"
                                      ...
                                      width="55px" viewBox="0 0 100 100" enable-background="new 0 0 100 100"
                                      xml:space="preserve">
                                  ...
                                  <h2>
                                    Canada tourist spots you must visit in 2024
                                  </h2>
                                </a>
                                <ul class="like-dislike">
                                  <li>
                                    <a class="bg-purple" href="#" title="Save to Pin Post"><i class="ti-pin2"></i></a>
                                  </li>
                                  <li>
                        ...
                        <div class="user-post">
                          <div class="friend-info">
                            ...
                            <div class="post-meta">
                              ...
                              <ul class="like-dislike">
                                <li>
                                  <a href="#" title="Save to Pin Post"><i class="ti-pin2"></i></a>
                                </li>
                                <li>
                                  <a href="#" title="Like Post"><i class="ti-thumb-up"></i></a>
                                </li>
                                <li>
                                  <a href="#" title="dislike Post"><i class="ti-thumb-down"></i></a>
                                </li>
                              </ul>
                              <div class="we-video-info">
                                <ul>
                  ...
                  <div class="col-lg-3 d-none d-md-block">
                    <aside class="sidebar static right">
                      ...
                      <div class="widget">
                        <h4 class="widget-title">Latest Video News</h4>
                        <div class="how-to">
                          <a href="https://youtu.be/TDGq4aeevgY" title="" data-strip-group="mygroup" class="strip"
                            data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
                              src="images/posts/7.webp" alt="img" style="width: 100%; height: 200px" />
                            <i>
                              <svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
                      ...
                      <div class="widget">
                        ...
                        <ul class="nav nav-tabs trend">
                          <li class="nav-item">
                            <a class="active" href="#trend" data-toggle="tab">Trending</a>
                          </li>
                          <li class="nav-item">
                        ...
                        <div class="tab-content">
                          <div class="tab-pane fade active show" id="trend">
                            <ul class="recent-links">
                              <li>
                                <figure>
                                  <img alt="" src="images/resources/recentlink-1.jpg" />
                                </figure>
                                <div class="re-links-meta">
                                  <h6>
                                    <a title="" href="#">moira's fade reaches much farther than
                                      you think.</a>
                                  </h6>
                              ...
                              <li>
                                <figure>
                                  <img alt="" src="images/resources/recentlink-2.jpg" />
                                </figure>
                                <div class="re-links-meta">
                                  <h6>
                                    <a title="" href="#">daniel asks if we want him to do the
                                      voice of doomfist</a>
                                  </h6>
                              ...
                              <li>
                                <figure>
                                  <img alt="" src="images/resources/recentlink-3.jpg" />
                                </figure>
                                <div class="re-links-meta">
                                  <h6>
                                    <a title="" href="#">the Voiz overwatch scandals.</a>
                                  </h6>
                          ...
                          <div class="tab-pane fade" id="hot">
                            <ul class="more-songs ps-container ps-theme-default"
                              data-ps-id="a7e5dfe0-752e-b05d-1057-03f8eab601e6">
                              <li>
                                <figure>
                                  <img alt="" src="images/resources/song-chanl1.jpg" />
                                </figure>
                                <div class="song-title">
                                  <h6>
                                    <a title="" href="#">6 Kiss (Feat. JuiceWrld &amp; YNW
                                      Melly)</a>
                                  </h6>
                              ...
                              <li>
                                <figure>
                                  <img alt="" src="images/resources/song-chanl2.jpg" />
                                </figure>
                                <div class="song-title">
                                  <h6>
                                    <a title="" href="#">A love letter to you for</a>
                                  </h6>
                              ...
                              <li>
                                <figure>
                                  <img alt="" src="images/resources/song-chanl3.jpg" />
                                </figure>
                                <div class="song-title">
                                  <h6>
                                    <a title="" href="#">Strings feat. Gunna Official</a>
                                  </h6>
                              ...
                              <li>
                                <figure>
                                  <img alt="" src="images/resources/song-chanl4.jpg" />
                                </figure>
                                <div class="song-title">
                                  <h6>
                              ...
                              <li>
                                <figure>
                                  <img alt="" src="images/resources/song-chanl5.jpg" />
                                </figure>
                                <div class="song-title">
                                  <h6>
                                    <a title="" href="#">Majin Mafia official song</a>
                                  </h6>
