                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="align-left">
                        <h5>Timeline Videos <span>62</span></h5>
                      </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row merged5">
                  <div class="col-lg-12">
                    <div class="featurepost">
                      <h5>
                        <svg class="svg-inline--fa fa-fire" aria-hidden="true" focusable="false" data-prefix="fas"
                          data-icon="fire" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                          data-fa-i2svg="">
                          <path fill="currentColor"
                        ...
                        </svg><!-- <i class="fa fa-fire"></i> -->Feature Video
                      </h5>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
                    <div class="item-box">
                      <a href="https://youtu.be/wrtm6JH7_3U" title="" data-strip-group="mygroup" class="strip"
                        data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
                          src="images/posts/1.webp" alt="post" style="width: 100%; height: 180px" />
                        <i>
                      ...
                      <div class="over-photo">
                        <a href="#" title=""><svg class="svg-inline--fa fa-heart" aria-hidden="true" focusable="false"
                  ...
                  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
                    <div class="item-box">
                      <a href="https://youtu.be/wrtm6JH7_3U" title="" data-strip-group="mygroup" class="strip"
                        data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
                          src="images/posts/2.webp" alt="post" style="width: 100%; height: 180px" />
                        <i>
                          <svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
                            viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
                  ...
                  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
                    <div class="item-box">
                      <a href="https://youtu.be/wrtm6JH7_3U" title="" data-strip-group="mygroup" class="strip"
                        data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
                          src="images/posts/3.webp" alt="post" style="width: 100%; height: 180px" />
                        <i>
                          <svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
                            viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
                  ...
                  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
                    <div class="item-box">
                      <a href="https://youtu.be/wrtm6JH7_3U" title="" data-strip-group="mygroup" class="strip"
                        data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
                          src="images/posts/4.webp" alt="post" style="width: 100%; height: 180px" />
                        <i>
                          <svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
                            viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
                  ...
                  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
                    <div class="item-box">
                      <a href="https://youtu.be/wrtm6JH7_3U" title="" data-strip-group="mygroup" class="strip"
                        data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
                          src="images/posts/5.webp" alt="post" style="width: 100%; height: 180px" />
                        <i>
                          <svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
                            viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
                  ...
                  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
                    <div class="item-box">
                      <a href="https://youtu.be/wrtm6JH7_3U" title="" data-strip-group="mygroup" class="strip"
                        data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
                          src="images/posts/6.webp" alt="post" style="width: 100%; height: 180px" />
                        <i>
                          <svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
                            viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
                  ...
                  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
                    <div class="item-box">
                      <a href="https://youtu.be/wrtm6JH7_3U" title="" data-strip-group="mygroup" class="strip"
                        data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
                          src="images/posts/7.webp" alt="post" style="width: 100%; height: 180px" />
                        <i>
                          <svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
                            viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
                  ...
                  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
                    <div class="item-box">
                      <a href="https://youtu.be/wrtm6JH7_3U" title="" data-strip-group="mygroup" class="strip"
                        data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
                          src="images/posts/8.webp" alt="post" style="width: 100%; height: 180px" />
                        <i>
                          <svg version="1.1" class="play" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="50px" width="50px"
                            viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
