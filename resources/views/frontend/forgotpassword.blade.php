    ...
    background-size: cover;
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-4">
                <div class="we-login-register" style="top: 50px !important">
                  <div class="text-dark mb-4" style="text-align: left">
                    ...
                    <h3 style="margin-bottom: 0">Your Password</h3>
                    <small
                  ...
                  <form class="we-form" method="post" action="/submit-forgot-password">
                    @csrf
                    <label
                      for="phone"
