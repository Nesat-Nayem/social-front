    ...
    <div class="widget">
      ...
      <div class="how-to">
        <a href="https://youtu.be/TDGq4aeevgY" title="" data-strip-group="mygroup" class="strip"
          data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img src="images/posts/7.webp" alt="img"
    ...
    <div class="widget">
      ...
      <div class="tab-content">
          ...
          <ul class="recent-links">
            <li>
              ...
              <div class="re-links-meta">
                <h6>
                  <a title="" href="#">moira's fade reaches much farther than you
                    think.</a>
                </h6>
            ...
            <li>
              ...
              <div class="re-links-meta">
                <h6>
                  <a title="" href="#">daniel asks if we want him to do the voice
                    of doomfist</a>
                </h6>
        ...
        <div class="tab-pane fade" id="hot">
          <ul class="more-songs ps-container ps-theme-default" data-ps-id="64b5f862-cee3-0234-6add-2f89815d959a">
            <li>
              <figure>
              ...
              <div class="song-title">
                <h6>
                  <a title="" href="#">6 Kiss (Feat. JuiceWrld &amp; YNW Melly)</a>
                </h6>
...
<div class="col-lg-8 col-md-8">
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="gen-metabox">
          <p style="text-align: justify">
            ...
            elit. Ipsum sapiente, modi nemo, sint ducimus iusto
            voluptatum veritatis non eos ea tenetur harum saepe
            aperiam commodi doloribus asperiores necessitatibus,
            id inventore perspiciatis nam dignissimos sunt
            recusandae! Unde, nisi qui maxime reiciendis nihil
            sunt accusamus dolore aperiam temporibus tenetur
            assumenda quasi. Magnam incidunt aperiam quisquam
            suscipit delectus, mollitia tempore. Quasi id,
            explicabo sapiente adipisci quam enim quas,
            aspernatur, asperiores iusto voluptatibus aliquid
            vitae delectus eum distinctio tempore quod ut animi
            quisquam fugit doloremque excepturi? Assumenda cum
            expedita debitis doloribus reiciendis quaerat
            labore, pariatur eos delectus dolore maxime minus
            quidem amet molestiae dolores dicta recusandae id
            officiis voluptates quo rem. Mollitia totam aliquam
            voluptas vitae id et laudantium tempora officia
            animi quas? Numquam dolore voluptatibus quas culpa
            veniam reprehenderit, deleniti ex neque id ipsa
            eligendi quaerat excepturi quae quo doloremque vero
            ipsam! Aspernatur quod, quasi id quaerat quisquam
            quae voluptate sed ducimus soluta voluptatem enim
            rerum quas sint non minus, maxime assumenda odit,
            amet aut nihil repellendus necessitatibus.
            Reiciendis sed sunt illum unde id cum suscipit, sit
            quas at, ducimus, atque excepturi. Voluptatibus
            veritatis, suscipit eos fuga, fugiat dolor soluta
            consequuntur, reiciendis placeat aperiam autem
            similique debitis quibusdam saepe esse? Facilis, ea
            reprehenderit.
          </p>
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div class="gen-metabox no-margin">
          <span><svg class="svg-inline--fa fa-sitemap" aria-hidden="true" focusable="false" data-prefix="fas"
              data-icon="sitemap" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
            ...
            </svg><!-- <i class="fa fa-sitemap"></i> -->
            Social Networks</span>
          <ul class="sociaz-media">
            <li>
              <a class="facebook" href="#" title=""><svg class="svg-inline--fa fa-facebook-f" aria-hidden="true"
                  focusable="false" data-prefix="fa-brands" data-icon="facebook-f" role="img"
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="">
                  <path fill="currentColor"
                    d="M279.1 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.4 0 225.4 0c-73.22 0-121.1 44.38-121.1 124.7v70.62H22.89V288h81.39v224h100.2V288z">
                  </path>
                </svg><!-- <i class="fa-brands fa-facebook-f"></i> --></a>
            </li>
            <li>
              <a class="twitter" href="#" title=""><svg class="svg-inline--fa fa-twitter" aria-hidden="true"
                  focusable="false" data-prefix="fa-brands" data-icon="twitter" role="img"
                ...
                </svg><!-- <i class="fa-brands fa-twitter"></i> --></a>
            </li>
            <li>
              <a class="google" href="#" title=""><svg class="svg-inline--fa fa-youtube" aria-hidden="true"
                  focusable="false" data-prefix="fa-brands" data-icon="youtube" role="img"
                ...
                </svg><!-- <i class="fa-brands fa-youtube"></i> --></a>
            </li>
            <li>
              <a class="vk" href="#" title=""><svg class="svg-inline--fa fa-instagram" aria-hidden="true"
                  focusable="false" data-prefix="fa-brands" data-icon="instagram" role="img"
                ...
                </svg><!-- <i class="fa-brands fa-instagram"></i> --></a>
            </li>
            <li>
              <a class="instagram" href="#" title=""><svg class="svg-inline--fa fa-tiktok" aria-hidden="true"
                  focusable="false" data-prefix="fa-brands" data-icon="tiktok" role="img"
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                  <path fill="currentColor"
                ...
                </svg><!-- <i class="fa-brands fa-tiktok"></i> --></a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div class="central-meta">
    <span class="create-post">Services (6)
      <a href="services.html" title="">See All</a></span>
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-6 text-center">
        <a href="social-post-detail.html">
          <div class="fav-play">
            <figure>
              <img src="images/services/1.jpg" alt="post" style="width: 100%; height: 150px" />
            </figure>
            <span class="tv-play-title">Social Issues </span>
          </div>
        </a>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6 text-center">
        <a href="social-post-detail.html">
          <div class="fav-play">
            <figure>
              <img src="images/services/2.jpg" alt="post" style="width: 100%; height: 150px" />
            </figure>
            <span class="tv-play-title">Medical Issues </span>
          </div>
        </a>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6 text-center">
        <a href="social-post-detail.html">
          <div class="fav-play">
            <figure>
              <img src="images/services/3.webp" alt="post" style="width: 100%; height: 150px" />
            </figure>
            <span class="tv-play-title">Daily News </span>
          </div>
        </a>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6 text-center">
        <a href="public-poll">
          <div class="fav-play">
            <figure>
              <img src="images/publick-poll.jpg" alt="post" style="width: 100%; height: 150px" />
            </figure>
            <span class="tv-play-title">Public Poll </span>
          </div>
        </a>
      </div>

      <div class="col-lg-4 col-md-6 col-sm-6 text-center">
        <a href="voters-summary.html">
          <div class="fav-play">
            <figure>
              <img src="images/voters.jpg" alt="post" style="width: 100%; height: 150px" />
            </figure>
            <span class="tv-play-title">voters-summary </span>
          </div>
        </a>
      </div>

      <div class="col-lg-4 col-md-6 col-sm-6 text-center">
        <a href="opinion-poll.html">
          <div class="fav-play">
            <figure>
              <img src="images/public.jpg" alt="post" style="width: 100%; height: 150px" />
            </figure>
            <span class="tv-play-title">Opinion Poll </span>
          </div>
        </a>
      </div>
    </div>
